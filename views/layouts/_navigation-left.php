...
<section class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
            ...
            <li><a href="#"><?= FA::fw('user') ?> Пользователи<?= $arrowIcon ?></a>
	            <?= MetisNav::widget([
		            'encodeLabels' => false,
		            'options' => ['class' => 'nav nav-second-level'],
		            'items' => [
			            ['label' => 'Просмотреть пользователей', 'url' => ['user/list']],
			            ['label' => 'Добавить пользователя', 'url' => ['user/create']],
		            ],
	            ]) ?></li><!-- Users -->
            <?php endif; ?>
			<li>
