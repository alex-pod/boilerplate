...
$userMenu = array(
	...
	'url' => '#',
	'items' => [
		['url' => '#', 'label' => FA::i('user')->fixedWidth() . ' Информация о пользователе', 'encode' => false],
		['url' => '#', 'label' => FA::i('gear')->fixedWidth() . ' Настройки', 'encode' => false],
		'<li class="divider"></li>',
...
if (!Yii::$app->user->isGuest) {
	$userMenu = array(
		...
		'url' => '#',
		'items' => [
			['url' => ['/user/update-own-info', 'id' => Yii::$app->user->identity->getId()], 'label' => FA::i('user')->fixedWidth() . ' Информация обо мне', 'encode' => false],
			['url' => '#', 'label' => FA::i('gear')->fixedWidth() . ' Настройки', 'encode' => false],
			'<li class="divider"></li>',
...
<div class="navbar-header">
	...
	<?= Html::a('CompanyName Admin', Yii::$app->homeUrl, ['class' => 'navbar-brand']) ?>
</div>
